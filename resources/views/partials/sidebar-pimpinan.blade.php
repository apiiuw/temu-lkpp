    ...
    <div class="border-b border-white/10 p-4">
        <div class="flex items-center gap-4">
            ...
            <div class="sidebar-hide-content sidebar-transition overflow-hidden">
                ...
                <h1 class="mt-1 text-xl font-black tracking-[0.03em] whitespace-nowrap">Pimpinan</h1>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-1 flex-col justify-between px-5 py-6">
        <div class="space-y-8">
            <div class="sidebar-hide-content sidebar-transition rounded-[28px] border border-white/10 bg-white/6 p-5 overflow-hidden">
                ...
                <p class="mt-3 text-lg font-bold truncate">{{ auth()->guard('pimpinan')->user()->name }}</p>
                <p class="mt-1 text-sm text-white/70 truncate">{{ auth()->guard('pimpinan')->user()->email }}</p>
            </div>
