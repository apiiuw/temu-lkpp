    ...
    <div class="border-b border-white/10 px-6 py-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <h1 class="mt-1 text-xl font-black tracking-[0.03em]">Superadmin Workspace</h1>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-1 flex-col justify-between px-5 py-6">
        <div class="space-y-8">
            <div class="rounded-[28px] border border-white/10 bg-white/6 p-5">
                ...
                <p class="mt-3 text-lg font-bold">{{ auth()->guard('superadmin')->user()->name }}</p>
                <p class="mt-1 text-sm text-white/70">{{ auth()->guard('superadmin')->user()->email }}</p>
            </div>
