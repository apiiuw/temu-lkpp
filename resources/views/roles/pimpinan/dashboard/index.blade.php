    ...
    <div class="mx-auto max-w-7xl">
        <div class="rounded-4xl border border-stone-200/80 bg-white/90 p-6 shadow-[0_24px_60px_rgba(120,53,15,0.10)] backdrop-blur-xl sm:p-8">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                <div class="max-w-3xl">
                    <p class="text-xs font-bold uppercase tracking-[0.3em] text-red-700">Dashboard Pimpinan</p>
                    <h1 class="mt-3 text-3xl font-black text-stone-900 sm:text-4xl">Selamat datang, {{ auth()->guard('pimpinan')->user()->name }}</h1>
                    <p class="mt-4 text-sm leading-relaxed text-stone-600">
                        Halaman ini adalah pusat kendali bagi pimpinan untuk memantau aktivitas operasional TemuLKPP.
                    </p>
                </div>
                ...
                <div class="rounded-[28px] border border-red-100 bg-[linear-gradient(145deg,#fff7ed_0%,#ffffff_100%)] p-5 shadow-sm lg:max-w-sm">
                    ...
                    <p class="mt-3 text-lg font-bold text-stone-900">{{ auth()->guard('pimpinan')->user()->email }}</p>
                    <p class="mt-2 text-sm leading-relaxed text-stone-600">
                        Akun ini aktif sebagai pimpinan internal TemuLKPP dengan akses ke ringkasan operasional seluruh agent.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-6">
            <div class="rounded-[28px] border border-stone-200/80 bg-white p-6 shadow-[0_18px_45px_rgba(28,25,23,0.06)]">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs font-bold uppercase tracking-[0.22em] text-red-600">Analisis Operasional Pimpinan</p>
                        <h2 class="mt-2 text-xl font-black text-stone-900">Dashboard Statistik Global & Kinerja</h2>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        // Use the newly generated Pimpinan Dashboard UUID directly
        const DASHBOARD_ID = '1a2b3c4d-5e6f-7a8b-9c0d-1e2f3a4b5c6d';
